...
// contains(names, 'Spencer', result => {
//   if(result === true){
//     console.log('Spencer is in the array')
//   } else {
//     console.log('Spencer is not in the array')
//   }
// })
...
// CODE HERE
const printString = (uniqArr) => console.log(`The new names array with all the duplicate items removed is ${uniqArr}`)
...
add24 = addingFactory(24)

// console.log(add24(13))